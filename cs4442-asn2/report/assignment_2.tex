...
To ease the problem of finding the longest ngram, I wrote a simple C++ source to find it based on a maximum $N$ value. This file is shown in \autoref{src:src/kbright2/p1
